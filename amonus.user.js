...
// ******  Coded by CarTierGL ******
// =====================================
// This Code can be adjust based on your balance 
// Default settings are for 10k bits balance 
var baseBet = 1; // In bits
var baseMultiplier = 1.05; // Target multiplier: 1.10 recommended depend on balance u have 
...
// Initialization
console.log('====== Deluxe\'s DeluxeBot ======');
...
engine.on('game_starting', function(info) {
    ...
    console.log('[Bot] Game #' + info.game_id);
      ...
      currentBet *= 6; // Then multiply base bet by 6!
